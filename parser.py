...
for file_path in file_paths:
    ...
    if file_path:
        ...
        # Example: print file being processed
...
if count > 1:
    ...
    print(f"✅ Done! File saved as 'output_table_combined.xlsx' in this executable's directory.")
else:
    df_final.to_excel(f'output_table_{file_name.lower()}.xlsx', index=False)
